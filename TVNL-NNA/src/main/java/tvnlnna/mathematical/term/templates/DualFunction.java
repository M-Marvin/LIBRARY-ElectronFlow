...
public class DualFunction extends BaseFunction {
	
	private final DualOperation operation;
	private final DualOperationDiff differentiation;
	
	public DualFunction(String name, int precedence, boolean leftassoative, DualOperation operation, DualOperationDiff differentiation) {
		super(name);
