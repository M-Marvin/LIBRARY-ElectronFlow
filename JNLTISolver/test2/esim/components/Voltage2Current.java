...
public class Voltage2Current extends FourPort {
	...
	public void stampMatricies(Context ctx, MatrixNd A, MatrixNd E, MatrixNd z) {
		...
		A.addM(this.nodeA, this.nodeC, +this.factor);
		A.addM(this.nodeB, this.nodeD, +this.factor);
		A.addM(this.nodeA, this.nodeB, -this.factor);
		A.addM(this.nodeB, this.nodeC, -this.factor);
