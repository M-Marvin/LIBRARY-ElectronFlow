...
public class DecimalPrefixFormater {
	...
	public static String formatDouble(double d) {
		...
		return String.format(Locale.US, "%.03f%c", d, prefix(exp));
	}
	...
	public static String formatFloat(float d) {
		...
		return String.format(Locale.US, "%3.03f%c", d, prefix(exp));
	}
	...
	private static final Pattern PPAT = Pattern.compile("(-?Infinity|[\\d,.]{1,}) ?([A-Za-z]?)");
